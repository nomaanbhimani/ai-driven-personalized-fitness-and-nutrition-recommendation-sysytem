    ...
    for week in range(1, num_weeks + 1):
        for day in range(1, 8):
            ...
            if "push pull legs" in workout_type:
                if day % 3 == 1:
                    workout_selection = exercises[exercises['Force'] == 'Push']
                elif day % 3 == 2:
                    workout_selection = exercises[exercises['Force'] == 'Pull']
                else:
                    workout_selection = exercises[exercises['Targeted Muscle'].isin(['Legs', 'Glutes', 'Hamstrings', 'Quads'])]
            elif "single" in workout_type:
                workout_selection = exercises[exercises['Mechanics'] == 'Single']
            else:
                workout_selection = exercises[exercises['Mechanics'] == 'Compound']
